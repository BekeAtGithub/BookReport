...
const bespokeDetailedReports = {
  ...
  meditations: [
    ...
    `At the same time, the book is strongly civic. Marcus does not use philosophy to justify withdrawal from duty. He keeps calling himself back to service, work, and cooperation with other human beings, even when they are foolish, selfish, or exhausting. This is one of the most important things about Meditations: the ideal self it imagines is not detached from the world, but active within it without being inwardly conquered by it.`,
    `The book endures because it records philosophy as practice rather than display. Meditations remains alive whenever readers recognize in Marcus the same recurring struggle they know in themselves: the mind drifting toward vanity, frustration, distraction, fear, or laziness and then being forced back toward clarity, responsibility, and self-command. Its greatness lies in that repeated return.`
  ]
};
